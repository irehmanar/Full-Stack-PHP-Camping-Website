...
<body>
  ...
  <div class="container d-flex justify-content-center flex-wrap mt-5">
    ...
    <div class="mx-3 my-4">
      <form class="input-group" style="width: 19rem">
        <span class="input-group-text"><i class="fas fa-calendar-days"></i></span>
        <input type="date" class="form-control" style="height: 38px" placeholder="Enter Date" />
      </form>
    </div>
    ...
    <div class="btn btn-danger mx-3 my-4">Search</div>
  </div>
    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item">
          <img src="des-2.jpg"  loading="lazy"  class="d-block w-100" style="height: 28rem;" alt="Destination 2">
        </div>
        <div class="carousel-item">
          <img src="des-3.jpg"  loading="lazy" class="d-block w-100" style="height: 28rem;" alt="Destination 3">
        </div>
        <div class="carousel-item">
          <img src="des-4.jpg"  loading="lazy" class="d-block w-100" style="height: 28rem;" alt="Destination 4">
        </div>
        <div class="carousel-item active">
          <img src="des-1.jpg"  loading="lazy" class="d-block w-100" style="height: 28rem;" alt="Destination 1">
        </div>
        <div class="carousel-item">
          <img src="des-5.jpg"  loading="lazy" class="d-block w-100" style="height: 28rem;" alt="Destination 5">
        </div>
      </div>
